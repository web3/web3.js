...
export default abstract class AbstractSocketProvider extends AbstractProvider {
   ...
   */
  private requestQueue: Map<number, RequestItem> = new Map();

  /**
   * @property responseQueue
   */
  private responseQueue: Map<number, RequestItem> = new Map();
   ...
   * @property CONNECT
   */
  private CONNECT: string = 'connect';

  /**
   * @property RECONNECT
   */
  private RECONNECT: string = 'reconnect';

  /**
   * @property NETWORK_CHANGED
   */
  private NETWORK_CHANGED: string = 'networkChanged';

  /**
   * @property CHAIN_CHANGED
   */
  private CHAIN_CHANGED: string = 'chainChanged';

  /**
   * @property ACCOUNTS_CHANGED
   */
  private ACCOUNTS_CHANGED: string = 'accountsChanged';
   ...
   */
  protected onClose(error = null): void {
  ...
  public getSubscriptionEvent(subscriptionId: string): string | undefined {
    ...
    this.subscriptions.forEach((value: SubscriptionItem, key: string) => {
