...
var Subscriptions = require('webtrue-core-subscriptions').subscriptions;
var Method = require('webtrue-core-method');
var utils = require('webtrue-utils');
var Net = require('webtrue-net');

var ENS = require('webtrue-eth-ens');
var Personal = require('webtrue-eth-personal');
var BaseContract = require('webtrue-eth-contract');
var Iban = require('webtrue-eth-iban');
var Accounts = require('webtrue-eth-accounts');
var abi = require('webtrue-eth-abi');
...
var Eth = function Eth() {
    ...
    // webtrue-eth would subsequently change the provider for _all_ contract
    // instances!
    var self = this;
    ...
    // make our proxy Contract inherit from webtrue-eth-contract so that it has all
        ...
        new Subscriptions({
            ...
            subscriptions: {
                ...
                'logs': {
                    ...
                    inputFormatter: [formatter.inputLogFormatter],
                    outputFormatter: formatter.outputLogFormatter,
                    // DUBLICATE, also in webtrue-eth-contract
