...
var Contract = function Contract(jsonInterface, address, options) {
    ...
    Object.defineProperty(this, 'ccipReadGatewayCallback', {
        get: function () {
            if (_this.options.ccipReadGatewayCallback) {
                return _this.options.ccipReadGatewayCallback;
            }

            return this.constructor.ccipReadGatewayCallback;
        },
        set: function (val) {
            _this.options.ccipReadGatewayCallback = val;
        },
        enumerable: true
    });
    Object.defineProperty(this, 'ccipReadGatewayUrls', {
        get: function () {
            if (
                _this.options.ccipReadGatewayUrls &&
                _this.options.ccipReadGatewayUrls.length
            ) {
                return _this.options.ccipReadGatewayUrls;
            }

            return this.constructor.ccipReadGatewayUrls;
        },
        set: function (val) {
            _this.options.ccipReadGatewayUrls = val;
        },
        enumerable: true
    });
