...
export class Contract extends Web3Context<EthExecutionAPI> {
	...
	private _jsonInterface!: AbiFragment[];
	...
	public constructor(
		...
		Object.defineProperty(this.options, 'jsonInterface', {
			set: (value: AbiFragment[]) => this._parseAndSetJsonInterface(value),
	...
	private _parseAndSetJsonInterface(abis: AbiFragment[]) {
		this._functions = {};
		this._events = {};
		const result: AbiFragment[] = [];
