...
describe('AllEventsOptionsMapperTest', () => {
    let allEventsOptionsMapper,
        allEventsFilterEncoderMock;
    ...
    it('constructor check', () => {
        expect(allEventsOptionsMapper.formatters)
            .toEqual(formatters);

        expect(allEventsOptionsMapper.allEventsFilterEncoder)
            .toEqual(allEventsFilterEncoderMock);
    });
    ...
    it('calls map with defined fromBlock property and returns the expected result', () => {
        ...
        expect(allEventsOptionsMapper.map({}, {}, options))
    ...
    it('calls map with undefined fromBlock property and returns the expected result', () => {
        expect(allEventsOptionsMapper.map({}, {defaultBlock: 'block'}, {}))
            .toHaveProperty('fromBlock', 'block');
    });
    ...
    it('calls map with defined filter property and returns the expected result', () => {
        ...
        expect(allEventsOptionsMapper.map({}, {defaultBlock: 0}, options))
            .toHaveProperty('topics', [0]);

        expect(allEventsFilterEncoderMock.encode)
    ...
    it('calls map with undefined address property and returns the expected result', () => {
        ...
        expect(allEventsOptionsMapper.map({}, {defaultBlock: 0, address: true}, options))
