 ...
 *
 *  var Contract = require('webtrue-eth-contract');
...
var Subscription = require('webtrue-core-subscriptions').subscription;
var formatters = require('webtrue-core-helpers').formatters;
var errors = require('webtrue-core-helpers').errors;
var promiEvent = require('webtrue-core-promievent');
...
var Contract = function Contract(jsonInterface, address, options) {
    ...
    if(!(this instanceof Contract)) {
        throw new Error('Please use the "new" keyword to instantiate a webtrue.eth.contract() object!');
    }
    ...
    // create topics based on filter
        ...
        if (event.name !== 'ALLEVENTS') {
            var indexedTopics = event.inputs.filter(function (i) {
                ...
                // TODO: https://github.com/ethereum/webtrue.js/issues/344
