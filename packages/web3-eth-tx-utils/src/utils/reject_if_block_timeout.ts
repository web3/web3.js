...
import { EthExecutionAPI, Bytes, Numbers } from 'web3-types';
import { rejectIfConditionAtInterval, toBigInt } from 'web3-utils';
...
export function rejectIfBlockTimeout(
	...
	return rejectIfConditionAtInterval(async () => {
		...
		const numberOfBlocks = lastBlockNumber - toBigInt(starterBlockNumber);
