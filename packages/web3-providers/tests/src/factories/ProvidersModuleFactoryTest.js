...
describe('ProvidersModuleFactoryTest', () => {
    ...
    it('createXMLHttpRequest returns instance of XMLHttpRequest', () => {
        expect(providersModuleFactory.createXMLHttpRequest('', 0, [{name: 'name', value: 'value'}], {}))
            .toBeInstanceOf(XHR);
        ...
        expect(xhrMock.nodejsSet)
            .toHaveBeenCalledWith({});

        expect(xhrMock.open)
            .toHaveBeenCalledWith('POST', '', true);
        ...
        expect(xhrMock.timeout)
            .toEqual(0);

        expect(xhrMock.withCredentials)
            .toEqual(true);
    });
    ...
    it('createWebsocketProvider returns instance of WebsocketProvider', () => {
        ...
        expect(w3cwebsocket)
            .toHaveBeenCalledWith(
                ...
                'string',
                null,
                {authorization: new Buffer.from([186, 199, 171, 157, 169, 158, 165, 171, 44, 194, 138, 221])},
                null,
                'string'
            );
    });
    ...
    it('createIpcProvider returns instance of IpcProvider', () => {
        ...
        expect(providersModuleFactory.createIpcProvider('path', net))
    ...
    it('createEthereumProvider returns instance of EthereumProvider', () => {
        expect(providersModuleFactory.createEthereumProvider({}))
