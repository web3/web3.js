 ...
 *
 * @param {Array<Number|String|BN>} keys
 *
 * @returns {Array<String>}
 */
export function inputStorageKeysFormatter = function (keys) {
 ...
 * @returns {object}
 */
export function outputProofFormatter (proof) {
 ...
 * @returns {BN} object
 */
var outputBigNumberFormatexport function = umber) {
 ...
 * @returns {Boolean}
 */
var isPredefinedBlockNumexport function = lockNumber) {
 ...
 * @returns {String}
 */
var inputDefaultBlockNumberFormatexport function = lockNumber) {
 ...
 * @returns object
 */
export function _txInputFormatter (options) {
 ...
 * @returns {String}
 */
export function inputSignFormatexport function = (data) {
 ...
 * @returns {Object}
 */
export function outputTransactionFormatexport (tx) {
 ...
 * @returns {Object}
 */
export function outputTransactionReceiptFormatexport (receipt) {
 ...
 * @returns {Object} log
 */
export inputLogFormatexport function (options) {
...
export outputSyncingFormatter (result) {
