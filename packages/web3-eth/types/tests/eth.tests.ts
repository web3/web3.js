...
import {Eth, BlockHeader, Syncing, Block, GetProof, PendingTransaction} from 'web3-eth';
...
// $ExpectType Promise<PendingTransaction[]>
eth.pendingTransactions();

// $ExpectType Promise<PendingTransaction[]>
eth.pendingTransactions((error: Error, result: PendingTransaction[]) => {});
