...
const mockRpcResponseHydrated: Block = {
	parentHash: '0xe99e022112df268087ea7eafaf4790497fd21dbeeb6bd7a1721df161a6657a54',
	sha3Uncles: '0x1dcc4de8dec75d7aab85b567b6ccd41ad312451b948a7413f0a142fd40d49347',
	miner: '0xbb7b8287f3f0a933474a79eae42cbca977791171',
	stateRoot: '0xddc8b0234c2e0cad087c8b389aa7ef01f7d79b2570bccb77ce48648aa61c904d',
 ...
 *     - hydrated
 */
export const testCases: [string, [Bytes | BlockNumberOrTag | undefined, boolean]][] = [
	...
	// TODO: Error from formatter when running tests: TypeError: Cannot delete property '0' of [object Uint8Array]
 ...
 */
type TestData = [string, [Bytes | BlockNumberOrTag | undefined, boolean, DataFormat], Block];
