...
function formatTransactionObject(transactionObject: EthTransaction): [EthTransaction] {
    for (const property in transactionObject) {
        // @ts-ignore
        if (typeof transactionObject[property] === 'bigint') transactionObject[property] = `0x${transactionObject[property].toString(16)}`
    }
