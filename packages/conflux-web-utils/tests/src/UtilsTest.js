...
describe('UtilsTest', () => {
    ...
    it('calls fromDrip and returns the expected results', () => {
        expect(fromDrip('1000000000000000000', 'drip')).toEqual('1000000000000000000');

        expect(fromDrip('1000000000000000000', 'gdrip')).toEqual('1000000000');

        expect(fromDrip('1000000000000000000', 'cfx')).toEqual('1');
    });
    ...
    it('calls toDrip and returns the expected results', () => {
        expect(toDrip('1', 'drip')).toEqual('1');

        expect(toDrip('1', 'gdrip')).toEqual('1000000000');

        expect(toDrip('1', 'Gdrip')).toEqual('1000000000');

        expect(toDrip('1', 'cfx')).toEqual('1000000000000000000');
    ...
    it('calls getSignatureParameters and returns the expected results', () => {
        const tests = [
            {
                value:
                    '0x5763ab346198e3e6cc4d53996ccdeca0c941cb6cb70d671d97711c421d3bf7922c77ef244ad40e5262d1721bf9638fb06bab8ed3c43bfaa80d6da0be9bbd33dc00',
