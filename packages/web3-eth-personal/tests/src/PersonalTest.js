...
describe('PersonalTest', () => {
    ...
    it('constructor check', () => {
        expect(personal.currentProvider)
            .toEqual(providerMock);

        expect(personal.providersModuleFactory)
            .toEqual(providersModuleFactoryMock);

        expect(personal.methodFactory)
            .toEqual(methodFactory);

        expect(personal.net)
            .toEqual(networkMock);

        expect(personal.utils)
            .toEqual(Utils);

        expect(personal.formatters)
            .toEqual(formatters);
    ...
    it('JSON-RPC methods check', () => {
        expect(personal.methodFactory.methods)
            .toEqual({
    ...
    it('calls setProvider and returns true', () => {
        ...
        expect(personal.setProvider('provider', 'net'))
            .toEqual(true);
    ...
    it('sets the defaultGasPrice property', () => {
        ...
        expect(personal.defaultGasPrice)
            .toEqual(10);
    ...
    it('sets the transactionBlockTimeout property', () => {
        ...
        expect(personal.transactionBlockTimeout)
            .toEqual(10);
    ...
    it('sets the transactionConfirmationBlocks property', () => {
        ...
        expect(personal.transactionConfirmationBlocks)
            .toEqual(10);
    ...
    it('sets the transactionPollingTimeout property', () => {
        ...
        expect(personal.transactionPollingTimeout)
            .toEqual(10);
    ...
    it('sets the defaultAccount property', () => {
        ...
        expect(personal.defaultAccount)
            .toEqual('0x2');
