...
describe('Web3CoreLogger', () => {
    ...
    it('should error with unsupportedError', () => {
        expect(() => {
            ...
            `{"loggerVersion":"${Version}","packageName":"testPackage","packageVersion":"1.0.0","name":"unsupportedError","msg":"Provided error does not exist in CoreErrors or provided Web3PackageErrorConfig","params":{"web3ErrorName":"fakeErrorName"}}`
        );
    });
});
