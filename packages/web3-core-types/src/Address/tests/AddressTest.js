...
describe('AddressTest', () => {
    ...
    it('constructor check', () => {
        expect(() => new Address(data.address)).not.toThrow();
    });

    it('has type property', () => {
        expect(new Address(data.address).isAddress).toBeTruthy();
    });

    it('parses to string', () => {
        const tests = [
            {value: '0x56D987AccaFc468b5E65786816103278f1119dC1'},
            {value: '0x4F38f4229924bfa28D58eeda496Cc85e8016bCCC'}
        ];
