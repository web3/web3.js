 ...
 * @return {Boolean}
 */
var isHederaAddress = function (address) {
    // check if it has the basic requirements of an address
 ...
 * @return {Boolean}
 */
var checkAddressChecksumHedera = function (checksum, address, client) {
...
module.exports = {
    ...
    toBN: toBN,
    isAddress: isAddress,
    isHederaAddress: isHederaAddress,
    isBloom: isBloom,
    ...
    checkAddressChecksumHedera: checkAddressChecksumHedera,
    utf8ToHex: utf8ToHex,
    hexToUtf8: hexToUtf8,
