...
import { IWeb3Provider } from '../../web3-providers-base/lib/types';
        ...
        try {
            ...
            switch (this.providerProtocol) {
                ...
                default:
                    ...
                    const defaultedCallOptions: Partial<CallOptions> = {
                        ...callOptions,
        ...
        try {
            ...
            switch (this.providerProtocol) {
                ...
                default:
                    ...
                    return this.provider.subscribe(defaultedCallOptions);
            }
        } catch (error) {
