...
/**
 * Prepare an IBAN for mod 97 computation by moving the first 4 chars
 * to the end and transforming the letters to
...
/**
 * This class should be used to create iban object from iban correct string
 *
 * @param {String} iban
 */
class Iban {
