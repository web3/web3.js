...
// import net from 'net';
import { httpStringProvider, ipcStringProvider } from '../fixtures/config';
...
describe('Web3 instance', () => {
	...
	describe('Create Web3 class instance with string providers', () => {
		...
		it('should create instance with string of IPC provider', async () => {
			...
			// new Web3.providers.IpcProvider(ipcStringProvider, new net.Socket());
			const web3 = new Web3(ipcStringProvider);
