    ...
    describe("accounts", function() {
        tests.forEach(function(test, i) {
            it("encrypt eth.account, and compare to ethereumjs-wallet", function() {
                ...
                assert.deepEqual(
                    acc.encrypt(pw, { n: n, salt: salt, iv: iv, uuid: uuid }),
                    ethWall.toV3(pw, { n: n, salt: salt, iv: iv, uuid: uuid })
                );
            });
            ...
            it("decrypt static signature using ethereumjs-wallet and eth.account and compare", function() {
                ...
                var encrypt = {
                    ...
                    crypto: {
                        ciphertext:
                            "8b20d7797fee1c36ec2fff176e1778170745794ad2f124862f7f4bfc028daa27",
                        cipherparams: {
                        ...
                        kdfparams: {
                            dklen: 32,
                            salt:
                                "d78584e30aaf56781b4432116b1de9b1560b3ca6f4624624c14fb6e6d5638a48",
                            n: 256,
                            r: 8,
                            p: 1
                        },
                        mac:
                            "23d4497c779a6bc421f5cc54358309228389597f594448c5c900ad747f97401b"
                    }
                };
                ...
                assert.equal(
                    web3.utils.toChecksumAddress(
                        "0x143f8913e0417997304fc179b531ff4cb9cab582"
                    ),
                    acc.address
                );
            });
