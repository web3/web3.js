...
var tests = [
    ...
    { value: '-15', expected: -15},
    { value: '-0xf', expected: -15},
    { value: "0x657468657265756d", expected: new BN("657468657265756d", 16)},
    { value: "0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffd", expected: new BN("fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffd", 16)},
    { value: "-0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff", expected: -1 * new BN("ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff", 16)},
    { value: "-0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffd", expected: -1 * new BN("fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffd", 16)},
    { value: 0, expected: 0},
    { value: '0', expected: 0},
        ...
        tests.forEach(function (test) {
            if (test.error) {
                ...
                it('should turn ' + test.value + ' to ' + test.expected, function () {
                    if (BN.isBN(test.expected)) {
                        assert.strictEqual(utils.toNumber(test.value).toString(), test.expected.toString());
                    } else {
