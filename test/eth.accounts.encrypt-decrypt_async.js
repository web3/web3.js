    ...
    describe("accounts", function () {
        ...
        tests.forEach(function (test, i) {
            it("encrypt eth.account, and compare to ethereumjs-wallet", function(done) {
                ...
                acc.encrypt(pw, {n: n,salt: salt, iv: iv, uuid: uuid}, function(error, key){
                    assert.deepEqual(key, ethWall.toV3(pw, {n: n, salt: salt, iv: iv, uuid: uuid}));
            ...
            it("encrypt eth.account, and decrypt with ethereumjs-wallet", function(done) {
                ...
                // create account
                var acc = ethAccounts.create();
                acc.encrypt(pw, {n: n}, function (error, encrypt) {
            ...
            it("encrypt ethereumjs-wallet, and decrypt with eth.account", function(done) {
                var ethAccounts = new Accounts();
        ...
        staticTests.forEach(function (test, i) {
            it("decrypt staticTests and compare to private key", function(done) {
                ...
                // create account
                ethAccounts.decrypt(test.json, test.password, function (error, acc) {
