...
describe('ens', function () {
    ...
    describe('getters', function () {
        ...
        it('should call supportsInterface and return "true"', async function () {
            ...
            provider.injectValidation(function (payload) {
                ...
                assert.equal(payload.method, 'eth_call');
                assert.deepEqual(payload.params, [{
                    data: sha3(supportsInterfaceSignature).slice(0, 10) + '3b3b57de00000000000000000000000000000000000000000000000000000000',
