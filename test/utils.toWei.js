...
describe("lib/utils/utils", function() {
    describe("toWei", function() {
        it("should return the correct value", function() {
            ...
            assert.equal(
                utils.toWei("1", "mether"),
                "1000000000000000000000000"
            );
            assert.equal(
                utils.toWei("1", "gether"),
                "1000000000000000000000000000"
            );
            assert.equal(
                utils.toWei("1", "tether"),
                "1000000000000000000000000000000"
            );

            assert.equal(
                utils.toWei("1", "kwei"),
                utils.toWei("1", "femtoether")
            );
            assert.equal(
                utils.toWei("1", "szabo"),
                utils.toWei("1", "microether")
            );
            assert.equal(
                utils.toWei("1", "finney"),
                utils.toWei("1", "milliether")
            );
            assert.equal(
                utils.toWei("1", "milli"),
                utils.toWei("1", "milliether")
