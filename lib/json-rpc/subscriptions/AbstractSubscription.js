    ...
    subscribe(callback = null) {
        ...
        this.config.currentProvider
            ...
            .then((subscriptionId) => {
                ...
                this.config.currentProvider.on('error', this.errorListener.bind(this));
                this.config.currentProvider.on(this.id, this.subscriptionListener.bind(this));
            })
            .catch((error) => {
                if (this.callback) {
    ...
    unsubscribe(callback) {
        return this.config.currentProvider
            ...
            .then((response) => {
                ...
                this.config.currentProvider.removeListener('error', this.errorListener);
                this.config.currentProvider.removeListener(this.id, this.subscriptionListener);
