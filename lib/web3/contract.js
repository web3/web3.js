...
Contract.prototype._decodeEventABI = function (data) {
    ...
    //    var match = this.inputs.filter(function (j) {
    ...
    var argTopics = this.anonymous ? data.topics : data.topics.slice(1);
    var indexedTypes = this.inputs.filter(function (i) {
        return i.indexed === true;
    }).map(function (i) {
        return i.type;
    });
    var notIndexedTypes = this.inputs.filter(function (i) {
    ...
    var count = 0;
    result.returnValues = this.inputs.reduce(function (acc, current) {
...
Contract.prototype._encodeMethodABI = function (method, params) {
    ...
    return (signature) ? '0x'+ signature + paramsABI : paramsABI;
};
