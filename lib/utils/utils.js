...
// '0x546869734973412054657374203837232b2a24255f2d3f'
var toAscii2 = function (hex) {
    if (hex.slice(0, 2) === '0x')
        hex = hex.replace('0x', '');
    
    return toAscii2Convert(hex.slice(2)); // if we see 0x, we skip
};

function toAscii2Convert(hex) {
    if (!hex) return '';

    var code = parseInt(hex.slice(0, 2), 16);
     if (code === 0)
         return '';

    return String.fromCharCode(code) + toAscii2Convert(hex.slice(2));
}


// // longer and more complex
// var toAscii3 = function (hex) {
//     if(hex === '') return '';
//     var seq = hex.substring(0, 2);
//     if (seq === '0x') 
//         return toAscii3(hex.substr(2)); // if we see 0x, we skip
    
//     var code = parseInt(seq, 16);
    
//     if (code === 0) 
//         return '';
  
//     return String.fromCharCode(code) + toAscii3(hex.substr(2));
// };
