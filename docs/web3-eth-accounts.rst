...
``Promise`` returning ``Object``: The signed data RLP encoded transaction, or if ``returnSignature`` is ``true`` the signature values as follows:
    ...
    - ``txHash`` - ``String``: The transaction hash for the RLP encoded transaction.
...
.. code-block:: javascript
    ...
    > {
        ...
        txHash: '0xde8db924885b0803d2edc335f745b2b8750c8848744905684c20b987443a9593',
    }
    ...
    > {
        ...
        txHash: '0xd8f64a42b57be0d565f385378db2f6bf324ce14a594afc05de90436e9ce01f60',
    }
