...
<ReactPlayer playing={false} controls url='https://youtu.be/fW1PDApXCtM?si=dxyACED0Lhq7QfnX' />



### Chainlink plugin: web3.js, viem, ethers vs web3 plugin🧩

<ReactPlayer playing={false} url='https://youtu.be/iF_O7ggQaQw?si=fNrVRrZ5kDDSrqY9' />
