...
The `transactionBlockTimeout` is used over socket-based connections. This option defines the number of new blocks to wait for the **first confirmation**, otherwise the PromiEvent rejects with a timeout error.
