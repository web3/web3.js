...
This guide go through an example and will teach you how to use Web3modal with Vue
...
You are finished and have sucesfully created Web3modal with Vue. For additional information take a look into the interactive code editor above and the files.
